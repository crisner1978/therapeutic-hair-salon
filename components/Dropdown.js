    ...
    <div className="w-56">
      <Menu as="div" className="relative inline-block text-left">
        ...
        <Transition
          ...
          leave="transition ease-out duration-100 tansform"
          leaveFrom="translate-x-0"
          leaveTo="-translate-x-full"
        >
          <Menu.Items className="bg-gray-300 flex flex-col absolute w-56 inset-x-0 left-0 space-y-5 py-10 -ml-10 pl-[74px] h-80">
            <Menu.Item>
